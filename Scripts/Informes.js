    document.addEventListener('DOMContentLoaded', function () {
            ...
            fetch(`/Home/ObtenerErrorMes?code=${7}&año=${año}`)
        ...
        $(document).ready(function () {
            ...
            function drawChart(code, mes, tipo, año) {
                ...
                if (tipo === "tipoerror") {
                    ...
                    fetch(`/Home/ObtenerErrorImpacto?code=${code}&fecha=${mes}&año=${año}`)
                        .then(response => response.json())
                        .then(data => {
                    ...
                    fetch(`/Home/ObtenerErrorPerdida?code=${code}&fecha=${mes}&año=${año}`)
                        .then(response => response.json())
                        .then(data => {
                    ...
                    fetch(`/Home/ObtenerErrorCausa?code=${code}&fecha=${mes}&año=${año}`)
                        ...
                        .then(data => {
                            ...
                            tableHTML += '<tr><th>Causa</th><th>Errores</th></tr>';
                    ...
                    fetch(`/Home/ObtenerErrorQueja?code=${code}&fecha=${mes}&año=${año}`)
                        .then(response => response.json())
                        .then(data => {
                            ...
                            const options = {
                                width: 670,
                                height: 260,
                                title: 'Consolidado de Quejas cleinte',
                                legend: { position: 'top', maxLines: 8 },
                                tooltip: { isHtml: true },
                                hAxis: {
                                    title: 'Queja cliente',
